...
<body class="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen flex items-center justify-center p-4">
  ...
  <script>
    ...
    passwordError.id = 'password_error';
    ...
    confirmPasswordError.className = 'text-red-500 text-xs mt-1 hidden';
    confirmPasswordInput.parentNode.insertBefore(confirmPasswordError, confirmPasswordInput.nextSibling.nextSibling);
