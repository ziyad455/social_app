      ...
      <div class="p-8">
        ...
        <form action="" method="post">
          ...
          <div class="mb-6">
            ...
            >
            <div id="last_name_error" class="text-red-500"></div>
          </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const validateName = () => {
        ...
        if (!name) {
            ...
            setInvalid(nameInput, nameError, "First name must be at least 2 characters");
            return false;
    ...
    const validateLastName = () => {
        ...
        if (!lastName) {
            ...
            setInvalid(lastNameInput, lastNameError, "Last name must be at least 2 characters");
            return false;
